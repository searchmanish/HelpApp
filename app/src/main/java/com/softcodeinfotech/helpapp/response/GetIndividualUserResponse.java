...
public class GetIndividualUserResponse {
    ...
    public GetIndividualUserResponse withStatus(Integer status) {
        this.status = status;
        return this;
    }
    ...
    public GetIndividualUserResponse withMsg(String msg) {
        this.msg = msg;
        return this;
    }
    ...
    public GetIndividualUserResponse withInformation(Information information) {
        this.information = information;
        return this;
    }
