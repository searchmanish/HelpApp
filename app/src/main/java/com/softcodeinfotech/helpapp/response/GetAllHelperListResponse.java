...
public class GetAllHelperListResponse {
    ...
    public GetAllHelperListResponse withStatus(Integer status) {
        this.status = status;
        return this;
    }
    ...
    public GetAllHelperListResponse withMsg(String msg) {
        this.msg = msg;
        return this;
    }
    ...
    public GetAllHelperListResponse withInformation(List<Information> information) {
        this.information = information;
        return this;
    }
